    ...
    <div className='relative '>
      ...
      <Navbar/>
       ...
       <div className='text-center mt-20 text-gray-600'>
        <p className='date-para py-4 font-medium'>Published on {Moment(data.createdAt).format('MMMM Do YYYY')}</p>
          ...
          <div className='max-w-3xl mx-auto'>
           <p className='font-semibold mb-4'>Add your comment</p>  
            ...
            <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
              ...
              <button type='submit' className='comment-btn text-white rounded p-2 px-8 hover:scale-102 transition-all cursor-pointer'>Submit</button>
            </form>
          </div>   
